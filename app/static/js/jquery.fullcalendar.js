...
(function ($) {
	...
	$('head').append('<style>.fullcalendar-day {border-left: 1px dotted green;border-top: 1px dotted green;} '
		 ...
		 + '.fullcalendar-detail{border-radius:5px;position: absolute; z-index: 1000000; background-color: rgb(0, 0, 102); display: none; opacity: 0.8; padding: 5px; text-align: right;filter: Alpha(opacity=80);width:150px;}'
